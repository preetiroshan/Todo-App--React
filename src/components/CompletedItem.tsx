...
import { delete_todo_action} from "../redux/actions";
import { connect, useDispatch } from "react-redux";
import { todoItemProps } from "../types";
// import {delete_todo}
export default function CompletedItem(props: todoItemProps) {
	const dispatch = useDispatch()
	const DeleteItemButtonHandler = (id: number) => {
		dispatch(delete_todo_action(id));
		console.log(2);
  };
  // const DoneItemButtonHandler = (id, task) => {
	// 	props.dispatch(done_todo_action(id, task));
